<script lang="ts">
  ...
  import DispatcherLogWidget from '$lib/widgets/terminal/DispatcherLogWidget.svelte';
  import HaikuArchiveWidget from '$lib/widgets/terminal/HaikuArchiveWidget.svelte';
